...
#import "WYScorllTextLable.h"

@interface WYScorllTextLable () {
    CGFloat _width;
    CGFloat _height;
    CGFloat _textWidth;
    NSTimer *_timer;
...
@implementation WYScorllTextLable
...
- (void)initUSerInterface {
    ...
    _style = YBTextCycleStyleDefault;
    [self creatLabel];
}
...
- (void)labelChange {
    ...
    if (_style == YBTextCycleStyleDefault && _textWidth < _width) {
        [self stop];
        return;
    }
